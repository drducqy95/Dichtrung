...
BRANCH_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "Ta Trong Binh Vu Tru_Tam Bach Can Dich Vi Tieu": {
        ...
        "cover_prompt": "Bìa dọc 6x9, một bàn tay khổng lồ (Lý Khanh) đang lơ lửng trên một bình thủy tinh sáng rực rỡ, bên trong bình là tòa tháp Babel tí hon và cây Thế Giới, phong cách huyền ảo, cinematic.",
        "sample_chapter": 25,
